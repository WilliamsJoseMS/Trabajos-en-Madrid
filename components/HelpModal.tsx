...
import { X, HelpCircle, CheckCircle, Clock, FileText, Sparkles } from 'lucide-react';
    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gray-800 rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden animate-fade-in border border-gray-700">
        ...
        <div className="p-6 space-y-6 overflow-y-auto max-h-[70vh]">
          ...
          <div className="space-y-2">
             <h3 className="font-bold text-white flex items-center gap-2">
              <Sparkles size={18} className="text-purple-500" /> Analista IA
            </h3>
            <p className="text-sm text-gray-400 leading-relaxed">
              ¿Quieres saber cuánto ganaste el mes pasado o qué días trabajas más? 
              El Analista IA revisa tus datos y te da un resumen financiero inteligente.
            </p>
          </div>
